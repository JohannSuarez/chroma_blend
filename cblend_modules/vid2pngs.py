...
class Vid2PNGs:
    ...
    def custom_directory_name(self, name_input: str):
        '''
    ...
    def frame_namer(self, cap: cv2.VideoCapture, ret: bool, dir_name: str, frame_count: int, suffix: str):
        '''
    ...
    def frame_extract(self, vid_input: str, which_directory: str):
        '''
        ...
        duration = self.video_length(vid_input)
        if duration == 0:
        ...
        if __name__ == "__main__":
            ...
            dir_name = self.custom_directory_name(vid_input)
            ...
            self.frame_namer(cap, ret, dir_name, frame_count, suffix)
            ...
            if which_directory not in ("bw_frames", "source_frames"):
                ...
                return self.frame_namer(cap, ret, dir_name, frame_count, suffix)
